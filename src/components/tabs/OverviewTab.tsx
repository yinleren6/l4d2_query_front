...
export default function OverviewTab() {
    ...
    const fetchStats = useCallback(async () => {
        ...
        try {
            ...
            const [overviewResult, dailyResult] = await Promise.allSettled([
                request.get<OverviewStats>('/api/stats/overview', { signal }),
                request.get<DailyStat[]>('/api/stats/daily?days=7', { signal }),
            ])
